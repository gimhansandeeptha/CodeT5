...
def main():
    ...
    if args.do_train:
        ...
        external_decoder.to(args.device)
        ...
        for cur_epoch in range(args.start_epoch, int(args.num_train_epochs)):
            ...
            for step, batch in enumerate(bar):
                ...
                if args.model_type == 'roberta':
                    ...
                    self_level_key_value_obj2.__setitem__(self_attention_input.get('block_2')[0])
                    self_level_key_value_obj3.__setitem__(self_attention_input.get('block_3')[0])
                    self_level_key_value_obj4.__setitem__(self_attention_input.get('block_4')[0])
                    self_level_key_value_obj5.__setitem__(self_attention_input.get('block_5')[0])

                    cross_level_key_value_obj0.__setitem__(cross_attention_input.get('block_0')[0])
                    cross_level_key_value_obj1.__setitem__(cross_attention_input.get('block_1')[0])
                    cross_level_key_value_obj2.__setitem__(cross_attention_input.get('block_2')[0])
                    cross_level_key_value_obj3.__setitem__(cross_attention_input.get('block_3')[0])
